export const mock = {
  "actions": [{
    ...
    "execConfig": {"pageUID": "68738E069046DED4929404C54EBA7724"}
  }, {
    ...
    "type": "DynamicPageViewConfig", "config": {
      ...
      "areasConfig": [{
        ...
        "widgetConfig": {
          "type": "PAGE_VIEW",
          "dataType": null,
          "options": {"page_key": {"value": "ru.pbs.module.management.pages.dynamic.ProjectHeaderView"}}
        }
      }, {
        "areaName": "data_area",
        "widgetFlow": null,
        "widgetConfig": {"type": "BLANK", "dataType": null, "options": null}
      }, {
              ...
              "value": [{
                ...
                "config": {
                  "widgetConfig": {
                    "type": "TREE_LIST_VIEW",
                    "dataType": null,
                    "options": {"get_data_path": {"value": "get_requirement_data"}, "events": {"value": []}}
                  }
                }
              }, {
                "title": "Задачи",
                "config": {
                  "widgetConfig": {
                    "type": "TREE_LIST_VIEW",
                    "dataType": null,
                    "options": {"get_data_path": {"value": "get_task_data"}, "events": {"value": []}}
                  }
                }
              }, {
                "title": "Продукт",
                          ...
                          "actions": [{
                            ...
                            "options": {
                              ...
                              "widgetConfig": {
                                "type": "PAGE_VIEW",
                                "dataType": null,
                                "options": {"page_key": {"value": "ru.pbs.module.management.pages.dynamic.BuildPageView"}}
                              }
                            }
                          }]
                        }, {
                          ...
                          "actions": [{
                            ...
                            "options": {
                              ...
                              "widgetConfig": {
                                "type": "PAGE_VIEW",
                                "dataType": null,
                                "options": {"page_key": {"value": "ru.pbs.module.management.pages.dynamic.ComponentPageView"}}
                              }
                            }
                          }]
                        }]
            ...
            "innerGridConfig": {
              "value": {
                ...
                "areasConfig": [{
                  ...
                  "widgetConfig": {
                    "options": {
                      "fieldName": {"value": "releaseDate"},
                      "width": {"value": "100%"},
                      "additionalProperties": {"value": {}},
                      "inputFormat": {"value": "String"},
                      "height": {"value": "100%"}
                    }, "dataType": "String", "type": "INPUT"
                  }
                }, {
          ...
          "options": {
            "innerGridConfig": {
              "value": {
                ...
                "columnSize": "85% auto",
                "rowSize": "auto",
                "gridTemplate": ["component-name component-actions"],
                "areasConfig": [{
          ...
          "options": {
            "innerGridConfig": {
              "value": {
                ...
                "gridTemplate": ["include-component-label include-component-select", "type-label type-select", "description-label description-text-area", "include-product-label include-product-table"],
                "areasConfig": [{
